		...
		public function drawIndexedTriangleList (vertices : Vector<Vertex>, vertexCount : Int, indexList : Vector<Int>, triangleCount : Int) : Void
		{
			...
			while( ii < triangleCount )
			{
				...
				if (clipcount == 0) // no clipping required
				{
					//tv0
					tv0.z = 1 / tv0.w ;
					tv0.x = tv0.x * sm00 * tv0.z + sm30;
					tv0.y = tv0.y * sm11 * tv0.z + sm31;
					//tv1
					tv1.z = 1 / tv1.w ;
					tv1.x = tv1.x * sm00 * tv1.z + sm30;
					tv1.y = tv1.y * sm11 * tv1.z + sm31;
					//tv2
					tv2.z = 1 / tv2.w ;
					tv2.x = tv2.x * sm00 * tv2.z + sm30;
					tv2.y = tv2.y * sm11 * tv2.z + sm31;
		...
		*/
		override public function drawIndexedLineList (vertices : Vector<Vertex>, vertexCount : Int, indexList : Vector<Int>, indexCount : Int) : Void
		{
			...
			while( ii < indexCount )
			{
				...
				if (clipcount != 0) //clipping required
				{
					...
					if ((clipcount & 2) == 2)
					{
						...
						if (adot <= 0.0 ) {
							...
							t = adot / (((a.z - b.z) * plane.z) + ((a.w - b.w) * plane.w));
						    _tmpVertex.interpolate(b, a, t, false);
							a.x = _tmpVertex.x;
							a.y = _tmpVertex.y;
							a.z = _tmpVertex.z;
							a.w = _tmpVertex.w;
				...
				//tv0
				tv0.z = 1 / tv0.w ;
				tv0.x = (tv0.x * csm00) * tv0.z + csm30;
				tv0.y = (tv0.y * csm11) * tv0.z + csm31;
				//tv1
				tv1.z = 1 / tv1.w ;
				tv1.x = (tv1.x * csm00) * tv1.z + csm30;
				tv1.y = (tv1.y * csm11) * tv1.z + csm31;
