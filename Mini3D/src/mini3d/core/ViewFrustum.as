package mini3d.core
{
	...
	public class ViewFrustum
	{
		...
		public function recalculateBoundingBox () : void
		{
			...
			boundingBox.addPoint (getFarLeftUp ());
			boundingBox.addPoint (getFarRightUp ());
			boundingBox.addPoint (getFarLeftDown ());
			boundingBox.addPoint (getFarRightDown ());
		}
		...
		public function transform (matrix : Matrix4) : void
		{
			...
			matrix.translateVector(cameraPosition);
